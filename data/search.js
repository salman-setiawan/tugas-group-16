...
function Search(title){
    ...
    const Result = cards.filter(card => card.title.match(pattern)) 

    Result.forEach(card=>{
        const insertCard = `
            <div class="rounded overflow-hidden shadow-lgg img-tourism-1 ani-card">
...
const cards = [
    {
        ...
        picture: '../pict/photo/lodging/home.jpg'
    },
    {
        title: 'Nama Villa 2',
        description: 'Lorem ipsum dulur sit amet',
